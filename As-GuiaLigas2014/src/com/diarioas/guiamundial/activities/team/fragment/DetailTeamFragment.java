...
public class DetailTeamFragment extends TeamFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// Inflating layout
		generalView = inflater.inflate(R.layout.fragment_team_detail,
				container, false);
	...
	private void configureData() {
		...
		if (getArguments().containsKey("urlShield")
			...
			resid = DrawableUtils.getDrawableId(mContext, getArguments()
	...
	private void configureStar() {
		...
		((TeamActivity) getActivity()).getmImageFetcher2().loadImage(
				getArguments().get("starImage"),
	...
	private void configureVideo() {
		...
		if (videoImage != null && videoImageUrl != null
			...
			((TeamActivity) getActivity()).getmImageFetcher().loadImage(
		...
		if (videoUrl != null && !videoUrl.equalsIgnoreCase("")) {
			videoImage.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					// intent.putExtra("subsection",getArguments().getString("subsection"));
		...
		if (misterName != null && !misterName.equalsIgnoreCase("")) {
			...
			if (misterImageText != null
				...
				((TeamActivity) getActivity()).getmImageFetcher().loadImage(
						...
						R.drawable.galeria_imagenrecurso);
