package com.diarioas.guiamundial.activities.stadiums;
...
import com.diarioas.guiamundial.activities.stadiums.fragments.CityFragment;
import com.diarioas.guiamundial.activities.stadiums.fragments.SedeFragment;
import com.diarioas.guiamundial.activities.stadiums.fragments.StadiumFragment;
import com.diarioas.guiamundial.dao.model.stadium.Stadium;
import com.diarioas.guiamundial.dao.reader.DatabaseDAO;
import com.diarioas.guiamundial.dao.reader.RemoteStadiumsDAO;
import com.diarioas.guiamundial.dao.reader.RemoteStadiumsDAO.RemoteStadiumDetailDAOListener;
...
import com.diarioas.guiamundial.utils.viewpager.CustomViewPagerStadium;
	...
	private void callToOmniture(int pos) {
		if (pos == 0) {
			StatisticsDAO.getInstance(this).sendStatisticsState(
					...
					stad.getStadiumName(), null, null, Omniture.TYPE_ARTICLE,
