...
import com.diarioas.guialigas.activities.palmares.fragment.PalmaresSectionFragment;
...
import com.diarioas.guialigas.activities.stadiums.fragments.StadiumSectionFragment;
...
public class HomeActivity extends SlidingFragmentActivity implements
	...
	protected void onDestroy() {
		...
		ImageDAO.getInstance(mContext).eraseImageLoader();
	...
	private void configActionBar() {
		...
		final String headerLink = DatabaseDAO.getInstance(mContext)
		 ...
		 ImageDAO.getInstance(this).displayImage(headerLink, adsButton, 0);
