...
public class FlipViewController extends AdapterView<Adapter> {
  ...
  public static interface ViewFlipListener {
    ...
    public void movetTo(int anglePageIndex, float accumulatedAngle, boolean onActionUp);
  }
  ...
  private boolean overFlipBottomEnabled = false;
  ...
  public boolean isOverFlipBottomEnabled() {
	  return overFlipBottomEnabled;
  }

  public void setOverFlipBottomEnabled(boolean overFlipEnabled) {
	 this.overFlipBottomEnabled = overFlipEnabled;
  }
  ...
  public void movetTo(int anglePageIndex, float accumulatedAngle, boolean onActionUp){
	  if (onViewFlipListener!=null ){
		  if (accumulatedAngle < 0)
			  onViewFlipListener.movetTo(anglePageIndex, -accumulatedAngle*100/FlipCards.MAX_TIP_ANGLE, onActionUp);
	  }
  }
