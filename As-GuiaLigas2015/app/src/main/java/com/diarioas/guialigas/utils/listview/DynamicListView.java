...
package com.diarioas.guialigas.utils.listview;
...
public class DynamicListView extends ListView {
	...
	public interface DynamicListViewCustomListener {

		void changeSelectedView(long mMobileItemId, View selectedView);

		void unChangeSelectedView(long mMobileItemId);

		void swapElements();
		
	}
	
	protected  DynamicListViewCustomListener customListener;
    ...
    public void setCustomListener(DynamicListViewCustomListener listener) {
            ...
            new AdapterView.OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                    ...
                    if (customListener!=null) {
                  	   customListener.changeSelectedView(mMobileItemId, selectedView);
                     }
...
//        can.drawRect(rect, paint);
    ...
    private void swapElements(ArrayList arrayList, int indexOne, int indexTwo) {
        ...
        if (customListener!=null) {
        	this.customListener.swapElements();
        }
    ...
    private void touchEventsEnded () {
        ...
        if (customListener!=null) {
      	   customListener.unChangeSelectedView(mMobileItemId);
         }
